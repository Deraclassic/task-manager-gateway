package com.dera.taskmanagergateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.dera.taskmanagergateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.dera.taskmanagergateway.security.DomainUserDetailsService", "createSpringSecurityUser");
